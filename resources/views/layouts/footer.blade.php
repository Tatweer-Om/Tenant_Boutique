...
@endphp
    ...
    @if ($route_name == 'size')
         ...
         @include('custom_js.color_js')
          @elseif ($route_name == 'channel' && \Nwidart\Modules\Facades\Module::isEnabled('Channel'))
   ...
   @elseif ($route_name == 'boutique' && \Nwidart\Modules\Facades\Module::isEnabled('Boutique'))
         @include('custom_js.boutique_js')
  @elseif ($route_name == 'boutique_list' && \Nwidart\Modules\Facades\Module::isEnabled('Boutique'))
         @include('custom_js.boutique_list_js')
           @elseif ($route_name == 'edit_boutique' && \Nwidart\Modules\Facades\Module::isEnabled('Boutique'))
         @include('custom_js.edit_boutique_js')
           @elseif ($route_name == 'stock')
         @include('custom_js.stock_js')
            @elseif ($route_name == 'add_stock' && \Nwidart\Modules\Facades\Module::isEnabled('Stock'))
         @include('custom_js.add_stock_js_no_tailor')
            @elseif ($route_name == 'view_stock')
         @include('custom_js.stock_list_js_no_tailor')
          @elseif ($routeName == 'stock.audit')
         @include('custom_js.stock_audit_js')
              @elseif ($route_name == 'edit_stock')
         @if(\Nwidart\Modules\Facades\Module::isEnabled('Stock'))
         @include('custom_js.edit_stock_js_no_tailor')
         @else
         ...
         @include('custom_js.expense_category_js')
          @elseif ($route_name == 'area' && \Nwidart\Modules\Facades\Module::isEnabled('Area'))
         @include('custom_js.area_js')
          @elseif ($route_name == 'city' && \Nwidart\Modules\Facades\Module::isEnabled('City'))
         @include('custom_js.city_js')
          @elseif ($routeName == 'pos.orders.list' && \Nwidart\Modules\Facades\Module::isEnabled('Pos'))
         @include('custom_js.pos_orders_list_js')
          @elseif ($routeName == 'tailor_orders_list')
         @include('custom_js.tailor_orders_list_js')
          @elseif ($routeName == 'customer_profile' && \Nwidart\Modules\Facades\Module::isEnabled('Customer'))
         @include('custom_js.customer_profile_js')
            @elseif ($route_name == 'pos' && \Nwidart\Modules\Facades\Module::isEnabled('Pos'))
         @include('custom_js.pos_js')
                    @elseif (($route_name == 'boutique_profile' || $route_name == 'bouttique_profile') && \Nwidart\Modules\Facades\Module::isEnabled('Boutique'))
         @include('custom_js.boutique_profile_js')
           @elseif ($route_name == 'channel_profile' && \Nwidart\Modules\Facades\Module::isEnabled('Channel'))
