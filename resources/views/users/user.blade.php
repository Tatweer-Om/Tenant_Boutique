...
<main class="flex-1 p-8 bg-background-light dark:bg-background-dark overflow-y-auto" x-data="{ open: false, edit: false, del: false }">
    ...
    <div x-show="open" x-cloak
        class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50" id="add_user_modal" x-ref="userModal">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            name="notes" id="notes"
                            class="w-full border rounded-lg p-3 focus:ring focus:ring-[var(--primary-user)]"
                            rows="3"></textarea>
                    </div>
