...
<body>
    <div class="header">
        <h1>{{ trans('messages.pos_income_report', [], session('locale')) ?: 'POS Income Report' }}</h1>
    ...
    <div class="summary">
        ...
        <div class="summary-row">
            <span class="summary-label">@if(session('locale') == 'ar') الخصم @else Discount @endif:</span>
            <span class="summary-value">{{ number_format($totals['discount'], 3) }}</span>
        </div>
        <div class="summary-row">
        ...
        <div class="summary-row">
            <span class="summary-label">@if(session('locale') == 'ar') رسوم التوصيل @else Delivery Charges @endif:</span>
            <span class="summary-value" style="color: #2563EB;">{{ number_format($totals['delivery_charges'] ?? 0, 3) }}</span>
        </div>
        <div class="summary-row">
    ...
    <table>
        <thead>
            <tr>
                ...
                <th>{{ trans('messages.customer_name', [], session('locale')) ?: 'Customer Name' }}</th>
                <th>{{ trans('messages.phone_number', [], session('locale')) ?: 'Phone' }}</th>
        ...
        <tbody>
            ...
            <tr class="totals-row">
                ...
                <td><strong>{{ number_format($totals['discount'], 3) }}</strong></td>
